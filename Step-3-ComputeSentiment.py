...
def main():
    ...
    try:
        if PRODUCT_CATEGORY == 'Books':
            df = pd.read_pickle(path+'/processed_reviews.pkl')
            print('Read pickle file for Books')
        else:
    ...
    if 1:
        ...
        #upload_to_s3(f'{PRODUCT_CATEGORY}_sentiment_scores_1.parquet', bucketName)
    ...
    if 1:
        ...
        #upload_to_s3(f'{PRODUCT_CATEGORY}_sentiment_scores_2.parquet', bucketName)
        #print('Uploaded parquet to S3')
